...
extension OSCMessage: OSCConvertible {
    ...
    public static func parseArguments( _ tagIterator: inout IndexingIterator<Array<TypeTagValues?>>, _ index: inout ArraySlice<Byte>.Index, _ data: ArraySlice<Byte>) -> [OSCMessageArgument?]? { //swiftlint:disable:this cyclomatic_complexity swiftlint:disable:this line_length
